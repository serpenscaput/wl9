/* Program name:  WMAP.C
   ...
   Changes:  v1.0 - Original version.
	     ...
	     v3.2 - Minor mods, porting to acc, changed output
		    format to show wall colors.
*/
...
FILE *FP;
{
  ...
  fprintf(FP,"\n	88  Wall (purple?)		");
  fprintf(FP,"\n	**  Wall (purple with blood)	");
  fprintf(FP,"\n        a   Ammo		f Food");
  fprintf(FP,"\n        &&  Wall-lift           g Gun-4");
  fprintf(FP,"\n        VV  Exit from maze      k Key");
  fprintf(FP,"\n        |   Door                m Machine gun-3");
  fprintf(FP,"\n        -   Door                o Object");
  fprintf(FP,"\n        {   Lift door           s Sphere");
  fprintf(FP,"\n        [   Locked door         t Treasure");
  fprintf(FP,"\n        H   Hidden door         x Hulk");
  fprintf(FP,"\n        CC  Cell 		XX Cell with bones ");
  fprintf(FP,"\n        +   First aid kit       A entrance to level ");
  fprintf(FP,"\nDn  Dog: difficulty levels 1-n");
  fprintf(FP,"\nGn  Guard: difficulty levels 1-n");
  fprintf(FP,"\nBn  Blue guard: difficulty levels 1-n");
  fprintf(FP,"\f");
}
...

{
  ...
  if (X2) {
    ...
    switch (X1) {
      case 0x01: CH='#'; break; /* Wall */
      case 0x02: CH='%'; break; /* Wall */
      case 0x03: CH='b'; break; /* Banner */
      case 0x04: CH='h'; break; /* Hitler */
      case 0x05: CH='C'; break; /* Cell */
      ...
      case 0x0D: CH='A'; break; /* Entrance to level */
      case 0x0F: CH='B'; break; /* Steel plates */
      case 0x10: CH='V'; break; /* Landscape view */
      case 0x11: CH='O'; break; /* Wall */
      case 0x12: CH='w'; break; /* Wreath */
      case 0x13: CH='8'; break; /* Wall */
      case 0x14: CH='s'; break; /* Shield */
      case 0x15: CH='!'; break; /* Lift */
      case 0x19: CH='*'; break; /* Wall w/ blood */
      case 0x5A: CH='|'; break; /* Vert. door */
      case 0x5B: CH='-'; break; /* Horiz. door */
      case 0x5C: CH='['; break; /* Locked steel door (needs key) */
      case 0x5D: CH='~'; break; /* Locked door (needs key) */
      case 0x64: CH='{'; break; /* Lift entrance */
      case 0x6A: CH=' '; break; /* ????? */     
      case 0x6B:
      case 0x6C:
      case 0x6D:
...
int   X1,X2;  /* 2 input bytes */
{
  ...
  if (X2) {
    ...
    switch (X1) {
      ...
      case 0x62: CH='H'; break; /* Hidden door */
