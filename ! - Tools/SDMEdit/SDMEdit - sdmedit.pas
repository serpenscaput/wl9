{
  MapEdit 7.1     Wolfenstein/Spear of Destiny Map Editor

  ver 7.1 (K. van den Helm - 4/99)
      - Added ability to open Spear of Destiny Demo maps (SDM)
...
begin
  ...
  setcolor(13);
  outtextxy(188, TEXTLOC, 'Sdmedit v'+VERSION);
end;
...
{-------------}
  ...
  textmode(co80);
  writeln('SdmEdit 1.0                 Copyright (c) 1999  K v/d Helm');
  writeln;
