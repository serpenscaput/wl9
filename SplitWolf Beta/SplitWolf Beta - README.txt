SplitWolf Beta - version from 22.04.2012
...
Support for Wolf3D full, Wolf3D shareware, Spear of Destiny

Installation instructions:
------------------------------------

Simply unzip the files into your Wolf4SDL folder (with your original Wolf3D
files) and use SplitWolf4SDL.bat to play.

How to play:
------------

Simply run the SplitWolf4SDL.bat to play.

Batch file format:
"Wolf4SDL.exe --split 2 --splitres 640 400 --splitlayout 1x2"
